...
export const PriceList: React.FC<{ page: number }> = ({ page }) => {
  ...
  return  (
    ...
    {!product.isLoading ? <table className="w-full text-white border-collapse border-slate-300 shadow-md overflow-scroll">
        <thead>
          <tr>
            <th className="bg-base">کالا</th>
            <th className="bg-base">قیمت</th>
            <th className="bg-base">موجودی</th>
          </tr>
        </thead>
